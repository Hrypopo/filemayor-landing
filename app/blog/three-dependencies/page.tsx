...
const articleSchema = {
  ...
  '@type': 'Article',
  headline: "Why FileMayor ships four runtime dependencies — and why that's still minimal.",
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Why FileMayor ships four runtime dependencies', item: 'https://filemayor.com/blog/three-dependencies' },
  ],
};
    ...
    <>
      ...
      <Article
        header={{
          ...
          title: "Why FileMayor ships four runtime dependencies — and why that's still minimal.",
      ...
      >
        ...
        <P>
          FileMayor ships with four runtime dependencies: <Code>electron-updater</Code>,{' '}
          <Code>tar</Code>, <Code>yauzl</Code>, and <Code>framer-motion</Code>. That is the entire list.
        </P>
        ...
        <P>
          FileMayor uses four carefully selected packages for specific, constrained
          purposes — update delivery, archive handling, and interface animation.
          Rewriting these from scratch would increase maintenance burden, introduce new
          untested code paths, and distract from the core problem FileMayor solves.
        </P>
        <Pull>
