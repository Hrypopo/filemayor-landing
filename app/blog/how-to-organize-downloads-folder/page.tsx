...
const howToSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      text: 'Run "filemayor duplicates ~/Downloads" to find hash-identical files. Then run "filemayor dedupe ~/Downloads" to remove the extras — each deletion is journaled.',
    },
    {
      '@type': 'HowToStep',
      position: 4,
