...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${site.url}/teams`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${site.url}/mcp`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    ...
    { url: `${site.url}/vs/cleanmymac`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${site.url}/vs/dropzone`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${site.url}/vs/grandperspective`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${site.url}/vs/alfred`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${site.url}/vs/forklift`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
